...
tokenAPI='7002182797:AAFKV4y6J8wF6gFbKEOUDrwoiLgLFCJOQak'
...
async def get_video(message:types.Message):
   ...
   file_type=video_file.mime_type
   duration=video_file.duration
   if duration>60:
       await message.answer('Iltimos video davomiyligi 60 dan past bolsin')
   else:
        if file_size>10:
           await message.answer('Video fayl 10 MG dan kichik bolsin')
        else:
...
#    await message.answer(text=f'{file_uniqueId},{file_size},{file_name},{duration}')
